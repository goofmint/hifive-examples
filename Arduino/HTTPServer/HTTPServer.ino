...
void loop(void)
{
  ...
  if (client) {
    ...
    if (parsed) {
      ...
      Serial.print(F("Path: ")); Serial.print(path);Serial.println("'");
      ...
      if (strcmp(action, "GET") == 0) {
        ...
        if (strcmp(path, "/") == 0) {
          ...
          client.fastrprintln(F("    <link href=\"//dl.dropboxusercontent.com/u/49508/hifive-examples/stylesheets/chart.css\" rel=\"stylesheet\">"));
          ...
          client.fastrprintln(F("    <script src=\"//dl.dropboxusercontent.com/u/49508/hifive-examples/javascripts/graphic-renderer.js\"></script>"));
          client.fastrprintln(F("    <script src=\"//dl.dropboxusercontent.com/u/49508/hifive-examples/javascripts/chart.js\"></script>"));
    ...
    //Serial.print(F("Aanalog Input:")); Serial.println(val);
    delay(200);
  }
}
